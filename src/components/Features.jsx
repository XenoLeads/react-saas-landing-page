    ...
    <div className="w-full scroll-mt-16" ref={ref}>
      <div className="max-w-7xl flex flex-col mx-auto gap-12 py-20 px-8 max-sm:px-4">
        <div ref={register} data-section="default" data-stagger="50" className="flex flex-col justify-center items-center gap-4 text-center">
          <h2 className="font-semibold text-4xl">Everything you need to succeed</h2>
          <h3 className="text-xl sm:max-w-1/2 text-neutral-600 ">Powerful features designed to help your team collaborate better and ship faster.</h3>
        </div>
