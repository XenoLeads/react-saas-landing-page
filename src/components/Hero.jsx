    ...
    <div className="w-full pt-16" ref={ref}>
      <div className="max-w-7xl mx-auto h-full px-8 flex max-lg:flex-col justify-between items-center py-20">
        <div className="w-1/2 max-lg:w-full max-lg:gap-8 flex flex-col gap-6" ref={register} data-section="hero" data-stagger="50">
          <div
            data-animate
            className="w-fit bg-indigo-100 inline-flex justify-start items-center text-indigo-800 px-4 py-1 text-sm gap-2 rounded-full"
          >
            <Zap strokeWidth={1} size={16} />
            <p className="font-medium">Trusted by 50,000+ teams worldwide</p>
          </div>
          <h1 data-animate className="text-6xl max-lg:text-5xl font-bold">
            Manage projects with clarity and speed
          </h1>
          <h2 data-animate className="text-xl text-neutral-600">
          ...
          <div data-animate className="flex max-sm:flex-col gap-4 font-semibold items-center">
          ...
          <p data-animate className="text-neutral-500">
            Free 14-day trial. No credit card required.
          </p>
        </div>
        <div ref={register} data-section="hero" className="w-1/2 max-lg:w-full px-8">
          <img data-animate src={hero_illustration} alt="" draggable="false" className="h-full w-full max-lg:h-100 object-contain" />
        </div>
      </div>
    </div>
  );
